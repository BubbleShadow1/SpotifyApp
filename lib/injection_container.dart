...
//cubit
  ...
  sl.registerFactory<AuthCubit>(()=>AuthCubit(getCurrentUIDUseCase: sl.call(),signOutUseCase:sl.call() ,isSignInUseCase:sl.call() ));
...
sl.registerLazySingleton<CredentialCubit>(()=>CredentialCubit(googleauthusercase: sl.call(), forgotPasswordUseCase:sl.call(), signInUseCase:sl.call(), signUpUseCase:sl.call(), getCreateCurrentUserUseCase:sl.call(),));
...
sl.registerLazySingleton(()=>ForgotPasswordUseCase(repository:sl.call()));

sl.registerLazySingleton(()=>GetCreateCurrentUserUseCase(repository:sl.call()));

sl.registerLazySingleton(()=>Googleauthusercase(repository:sl.call() ));



sl.registerLazySingleton<AuthRepository>(()=>FirebaseRepoImpl(remoteDatasource:sl.call()));
